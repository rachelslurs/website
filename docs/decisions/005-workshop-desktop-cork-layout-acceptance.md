...
- **LCD 3D tilt vs peg hooks:** The faux LCD module uses `rotateX` while mount hooks stay outside the tilt subtree for lattice alignment — see [ADR-006: Workshop LCD — tilt vs peg-hook alignment](006-workshop-lcd-tilt-vs-peg-hook-alignment.md).
