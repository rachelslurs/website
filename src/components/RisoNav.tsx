...
export default function RisoNav({
  ...
  return (
    <motion.nav
      className="relative z-50 flex w-full flex-wrap items-center justify-center gap-nav-gap py-nav max-lg:py-nav-y-lg max-sm:py-nav-y-sm md:justify-between"
    ...
    >
      ...
      <ul
        className="flex list-none flex-wrap items-center justify-center gap-nav-links-gap md:justify-start"
        role="list"
      >
