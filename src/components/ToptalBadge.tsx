...
const RESUME_URL =
  "https://www.toptal.com/developers/resume/rachel-cantor#B3kwDz";
...
const HEX_POINTS = "50,0 100,24 100,76 50,100 0,76 0,24";

export default function ToptalBadge() {
  return (
    <aside
      className="toptal-badge-wrap"
      aria-label="Toptal top 3% talent certification"
    >
      <div className="toptal-badge-shadow">
        <div className="toptal-badge-hex">
          <svg
            className="toptal-badge-hex-border"
            viewBox="0 0 100 100"
            preserveAspectRatio="none"
            aria-hidden="true"
          >
            <polygon points={HEX_POINTS} className="toptal-badge-hex-shape" />
          </svg>
          <div className="toptal-badge-hex-inner">
            <div className="toptal-badge-top">
              <div className="toptal-badge-stars">
                <StarsIcon />
              </div>
              <p className="toptal-badge-title">Top 3% talent</p>
            </div>
            <div className="toptal-badge-brand">
              <div className="toptal-badge-rule" aria-hidden="true" />
            ...
            <a
              ...
              className="toptal-badge-cta card-link demo-link"
            >
              Hire me
            </a>
          </div>
