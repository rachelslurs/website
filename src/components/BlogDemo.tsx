...
type BlogDemoProps = {
  children: ReactNode;
  /**
   * Break out of the `prose prose-analog` ~65ch measure so charts / wide UIs use the
   * full looseleaf content band.
   */
  wide?: boolean;
};

/** Escape the reading column (`prose prose-analog`): wider box + equal negative L/R margins keeps the card centered. */
