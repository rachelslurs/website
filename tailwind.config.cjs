...
/* Font stacks, one definition per family. The "<Family> fallback" entries are
   metric-matched local faces generated by fontaine (astro.config.ts) — they
   hold the web font's geometry until it loads, so the swap doesn't shift
   text. A stack missing its fallback entry silently reintroduces font-swap
   CLS, so use these constants instead of pasting literals. */
const ZILLA_STACK = ["Zilla Slab", "Zilla Slab fallback", "Georgia", "serif"];
const LORA_STACK = ["Lora", "Lora fallback", "Georgia", "ui-serif", "serif"];
const ARCHIVO_STACK = [
  "Archivo Black",
...
const cssStack = stack => stack.join(", ");
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        serif: ZILLA_STACK,
        display: ARCHIVO_STACK,
        heading: ZILLA_STACK,
        body: LORA_STACK,
        mono: PLEX_MONO_STACK,
      },
      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            lineHeight: '1.65',
            fontSize: '1rem',
            fontFamily: cssStack(LORA_STACK),
            ...
            h1: {
              ...
              fontFamily: cssStack(ARCHIVO_STACK),
              marginTop: '1.25em',
              marginBottom: '0.5em',
            },
            'h1:first-child': {
            ...
            h2: {
              ...
              fontFamily: cssStack(ZILLA_STACK),
              marginTop: '1.25em',
              marginBottom: '0.5em',
            },
            'h2:first-child': {
            ...
            code: {
              fontFamily: cssStack(PLEX_MONO_STACK),
              fontSize: '0.9em',
